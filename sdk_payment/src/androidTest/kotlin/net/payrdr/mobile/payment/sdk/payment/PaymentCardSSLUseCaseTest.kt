...
import net.payrdr.mobile.payment.sdk.screen.fillOutWithEmailAndPhoneFieldsAndSend
...
class PaymentCardSSLUseCaseTest: BaseTestCase() {
    ...
    fun shouldReturnSuccessPaymentDataWithNewCardSSLWithNoUse3DS2SDKSDKWithSaveCard() {
        ...
        run {
            ...
            step("Input cvc") {
                SelectedCardScreen {
                    fillOutWithEmailAndPhoneFieldsAndSend(cardSuccessSSL)
                }
            }
            step("Verify result") {
                verifyResult {
    ...
    fun shouldReturnErrorPaymentDataWithNewCardSSLWithNoUse3DS2SDKSDKWithSaveCardWithInvalidCVC() {
        ...
        run {
            ...
            step("Input cvc") {
                SelectedCardScreen {
                    fillOutWithEmailAndPhoneFieldsAndSend(cardSuccessSSL.withInvalidCVC())
                }
            }
            step("Verify result") {
                verifyResult {
